...
///
/// For example, apply the `ics721_incoming_proxy_execute` macro to the following enum:
///
/// ```rust
/// use cosmwasm_schema::cw_serde;
/// use cw_ics721_incoming_proxy_derive::ics721_incoming_proxy_execute;
///
...
pub fn ics721_incoming_proxy_execute(metadata: TokenStream, input: TokenStream) -> TokenStream {
    merge_variants(
        metadata,
        input,
        quote! {
...
///
/// For example, apply the `ics721_incoming_proxy_query` macro to the following enum:
///
/// ```rust
...
/// https://github.com/larry0x/cw-plus-plus/tree/main/packages/ownable
#[proc_macro_attribute]
pub fn ics721_incoming_proxy_query(metadata: TokenStream, input: TokenStream) -> TokenStream {
    merge_variants(
        metadata,
        input,
        quote! {
